...
obj = (1000*param.gasoline_density/(param.liter2gallon*MPG) + weight.NOx*NOx + weight.CO*CO + weight.HC*HC)*10.2567;  %output of emissions was in g/mile, DP did g oprimization
