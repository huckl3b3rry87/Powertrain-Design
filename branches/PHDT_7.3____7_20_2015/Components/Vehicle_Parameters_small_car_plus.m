...
% Base Vehicle
plus = 450; % kg
Base_Vehicle = glider_mass + tx_mass + ex_mass + plus;
...
% Test 1
test.V(1) = 85*param.mph_mps;
test.alpha(1) = 0*pi/180;
% Test 2
test.V(2) = 55*param.mph_mps;
test.alpha(2) = 5*pi/180;

% acceleration test
test.V_0_n = 0*param.mph_mps;
test.V_f_n = 60*param.mph_mps;
test.dt_2 = 12;
