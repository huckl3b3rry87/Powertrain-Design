...
eng_consum_spd=[0 104.5 149.2 220.9 292.5 364.1 435.7 507.4 552.2 596.9];
eng_consum_spd_old = eng_consum_spd;
% (N*m), torque range of the engine
eng_consum_trq=[0 6.8 13.6 20.4 27.2 33.8 40.6 47.4 54.2 61 67.8 74.6 81.4]; % added zero
...
eng_max_trq=[61 61	67.6 73.7 78.5 80.9 77.3 76.2 73.3 68.7];
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
W_eng_min = 0;  % changed to let it opperate at low speeds
