function [ PASS, Sim_Variables, time_sixty, Acc_Test ] = Acceleration_Test(V_0,V_f, Acc_Final, dt_2, param, vinf, dvar, TYPE)
...
%         Fti = T_eng_max*ni/vinf.rwh + Tm_max*dvar.FD*dvar.G/vinf.rwh;
        Fti = Tm_max*dvar.FD*dvar.G/vinf.rwh;                         % Motor Only
...
if in == 1
    if TYPE == 1  % Final Velocity Req.
        ...
        if Final_Velocity < V_f
            ...
            PASS = 1;
            time_sixty = time_sim(I);
        end
        
    else   % Acceleration req.
        time_sixty = 100; % Different test
